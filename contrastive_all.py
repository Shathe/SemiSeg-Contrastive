    ...
    for i_iter in range(start_iteration, num_iterations):
        ...
        if contrastive_labeled_loss:
            ...
            if i_iter > RAMP_UP_ITERS:  # RAMP_UP_ITERS:
                ...
                loss_contr_labeled = contrastive_class_to_class_basic_all(pred_labeled_features_all, labels_down_all, labeled_prediction_probs_all,
                ...
                loss_contr_unlabeled = contrastive_class_to_class_basic_all(pred_feat_unlabeled, joined_pseudolabels_down, unlabeled_prediction_probs_down,
