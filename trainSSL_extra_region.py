...
from utils.feature_memory_ema import *
...
def main():
    ...
    feature_memory_ema = FeatureMemoryEma(feature_size=256, n_classes=num_classes)
    ...
    for i_iter in range(start_iteration, num_iterations):
        ...
        if contrastive_labeled_loss:
            ...
            if RAMP_UP_ITERS  - 1000:  # RAMP_UP_ITERS  - 1000:
                ...
                feature_memory_ema.add_features_from_sample_random(proj_labeled_features_correct, labels_down_correct, ema_update=0.998)
            ...
            if i_iter > RAMP_UP_ITERS:  # RAMP_UP_ITERS:
                ...
                loss_contr_labeled_region = contrastive_class_to_class_region(pred_labeled_features_all, labels_down_all, num_classes, feature_memory_ema.memory)

                loss = loss + loss_contr_labeled_region * 0.1
