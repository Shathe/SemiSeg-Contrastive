...
parser.add_argument("--input_dir", help="Dataset to train", default='./output_images')
parser.add_argument("--output_dir", help="Dataset to train", default='./colored_output_images')
