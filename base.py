...
def main():
    ...
    for i_iter in range(start_iteration, num_iterations):
        ...
        if supervised_labeled_loss:
            labeled_loss = supervised_loss(labeled_pred, joined_labels,
                                           weight=class_weights.float())  # weight=class_weights.float()
        ...
        if contrastive_labeled_loss:
            ...
            if i_iter > RAMP_UP_ITERS - 1000:  # RAMP_UP_ITERS  - 1000:
                ...
                feature_memory.add_features_from_sample(proj_labeled_features_correct, labels_down_correct,
                                                        batch_size_labeled)
            ...
            if i_iter > RAMP_UP_ITERS:  # RAMP_UP_ITERS:
                ...
                loss_contr_labeled = contrastive_class_to_class(pred_labeled_features_all, labels_down_all,
                ...
                loss_contr_unlabeled = contrastive_class_to_class(pred_feat_unlabeled, joined_pseudolabels_down,
